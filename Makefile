...
OpenClaw_OBJCFLAGS = -fno-objc-arc

OpenClaw_FRAMEWORKS = UIKit Foundation Security CoreGraphics QuartzCore AudioToolbox AVFoundation SystemConfiguration CFNetwork IOKit

OpenClaw_LIBRARIES = sqlite3

OpenClaw_CFLAGS += -Os -ffast-math -fvisibility=hidden -fvisibility-inlines-hidden
OpenClaw_LDFLAGS = -dead_strip -ldl

OpenClaw_RESOURCE_DIRS = Resources

include $(THEOS_MAKE_PATH)/application.mk

SUBPROJECTS += OpenClawPrefs OpenClawTweak OpenClawNC ClawPodDaemon
